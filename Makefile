...
app.build_dev:
	docker compose docker-compose.dev.yml build --no-cache \ docker compose docker-compose.dev.yml down

app.start_dev:
	docker compose -f docker-compose.dev.yml down && docker compose -f docker-compose.dev.yml up \ docker compose -f docker-compose.dev.yml down 
